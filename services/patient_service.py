...
class PatientService:
    ...
    def get_patient_exams(patient_id):
        return query("""
            SELECT e.*, 
                   COALESCE(ef.estado_geral, eo.observacoes) as resumo_clinico,
    ...
    def get_patient_treatments(patient_id):
        ...
        treatments = query("""
            SELECT tp.*, u.username as professor_nome 
    ...
    def get_patient_prosthesis(patient_id):
        ...
        if prosthesis_active:
            etapas = query("""
                SELECT e.*, u.username as professor_nome
    ...
    def get_patient_full_profile(patient_id):
        ...
        students = query("SELECT id, username FROM users WHERE role = %s ORDER BY username ASC", (Role.ALUNO,))
